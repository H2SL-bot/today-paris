...
export const UI = {
  fr: {
    ...
    openNow: "Seulement ce qui est ouvert maintenant", submit: "Qu'est-ce que je fais maintenant ?",
    ...
    interest: "👍 Ça m'intéresse", noted: "✓ Noté",
  ...
  en: {
    ...
    openNow: "Only what's open right now", submit: "What should I do right now?",
    ...
    interest: "👍 I'm interested", noted: "✓ Noted",
